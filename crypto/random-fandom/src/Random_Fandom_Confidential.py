...
secret = "576ECDEAC22E32AFC89F16149C49BF5506D9B55F04E29F78B8850259BE59D772" #REDACTED
flag = "GLUG{50_mUch_R4nd0m_3nCr1P710n_D79288C4D4D67DF8}"  #REDACTED

def keygen(n):
	privKey = [0]*n
	privKey[0] = 14073621 #REDACTED
	for i in range(1, n):
		total = sum(privKey)
